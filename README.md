...
An unofficial desktop app for NTS built in Electron and ported to Windows.
...
Go to the [Releases Page](https://github.com/dzndani/dznts/releases) and
download the latest Windows installer (`.exe`).

[Looking for a macOS release?](https://github.com/romeovs/nts-desktop/releases)
...
The main idea for this port comes from the awesome
[nts-desktop](https://github.com/romeovs/nts-desktop), since it was only for macOS and i wanted a windows app so badly that i just had to start porting it, and for the beautiful design it has.
